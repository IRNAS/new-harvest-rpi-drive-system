...
btns = dbc.Row(
    ...
    children=[
        dbc.Row(
            children=[
                dbc.Button(html.Span("OFF", style={"position": "relative", "left": "-14px", "top": "-10px", "font-size": "14px", "font-weight": "bold"}), id="btn-shutdown", n_clicks=0, className="mr-2", style={"height": "2px", "width": "2px", "margin-top": "-10px"}),
                dbc.Button(html.Span("\U000021BB", style={"position": "relative", "left": "-12px", "top": "-16px", "font-size": "24px", "font-weight": "bold"}), id="btn-restart-device", n_clicks=0, className="mr-2", style={"height": "2px", "width": "2px", "margin-top": "-10px"}),
